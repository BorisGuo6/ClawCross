...
VALID_KEYS = {
    ...
    "WHITELIST_FILE",
    "NONEBOT_ADAPTERS", "NONEBOT_HOST", "NONEBOT_PORT", "NONEBOT_DRIVER",
    "NONEBOT_ALLOW_OVERLAP", "NONEBOT_LOG_LEVEL",
    "TELEGRAM_BOTS", "QQ_BOTS", "QQ_IS_SANDBOX",
    "CLAWCROSS_WECHAT_ENABLED", "CLAWCROSS_WECHAT_BIN", "CLAWCROSS_WECHAT_USERNAME", "CLAWCROSS_WECHAT_CONFIG",
    "CLAWCROSS_WECHAT_PROXY_PORT", "CLAWCROSS_WECHAT_PROXY_HOST", "CLAWCROSS_WECHAT_AUTO_INSTALL",
    ...
    "OPENCLAW_WEIXIN_API_TIMEOUT_MS", "OPENCLAW_WEIXIN_BOT_AGENT",
}
