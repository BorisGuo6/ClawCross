...
| Compare ClawCross with Rust Claude-Code-adjacent tools or decide whether to rewrite ClawCross in Rust             | [`adr/2026-07-09-rust-rewrite-scope.md`](./adr/2026-07-09-rust-rewrite-scope.md)                                                                                 | [`webot-claude-gap-analysis.md`](./webot-claude-gap-analysis.md), [`repo-index.md`](./repo-index.md)                                                               |
...
| Add or debug remote Claude computers in Project Harness                                                           | [`remote-claude-harness.md`](./remote-claude-harness.md)                                                                                                         | [`harness-workspaces.md`](./harness-workspaces.md), [`ports.md`](./ports.md), [`runtime-reference.md`](./runtime-reference.md), [`repo-index.md`](./repo-index.md) |
| Configure or debug ACP / acpx (external agent communication)                                                      | [`runtime-reference.md`](./runtime-reference.md), [`acpx-provider-harness.md`](./acpx-provider-harness.md), [`remote-acpx-harness.md`](./remote-acpx-harness.md) | [`build_team.md`](./build_team.md), [`oasis-reference.md`](./oasis-reference.md), [`repo-index.md`](./repo-index.md)                                               |
...
| Use the local Codex quota-aware queue runner                                                                      | [`codex-quota-scheduler.md`](./codex-quota-scheduler.md)                                                                                                         | [`cli.md`](./cli.md), [`repo-index.md`](./repo-index.md)                                                                                                           |
| Enable Claude keepalive scheduling                                                                                | [`claude-keepalive-scheduler.md`](./claude-keepalive-scheduler.md)                                                                                               | [`webot-agent-runtime.md`](./webot-agent-runtime.md), [`cli.md`](./cli.md), [`repo-index.md`](./repo-index.md)                                                     |
...
- [`codex-quota-scheduler.md`](./codex-quota-scheduler.md): local Codex queue runner with active windows, cooldowns, and macOS LaunchAgent setup
- [`claude-keepalive-scheduler.md`](./claude-keepalive-scheduler.md): Claude keepalive runner for enabled WeBot records, reset parsing, and macOS LaunchAgent setup
...
- [`acpx-provider-harness.md`](./acpx-provider-harness.md): typed ACPX provider registry, Paseo manifest integration, session waits, runner affinity, and local validation
- [`harness-workspaces.md`](./harness-workspaces.md): OpenHands-style harness workspace backends, lifecycle API, and validation
...
- [`adr/2026-07-09-rust-rewrite-scope.md`](./adr/2026-07-09-rust-rewrite-scope.md): CCometixLine comparison and Rust rewrite boundary decision
